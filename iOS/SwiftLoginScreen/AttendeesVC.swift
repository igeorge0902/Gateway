...
var attendeesArray: [NSDictionary] = [NSDictionary]()
...
class AttendeesVC: UIViewController, UITableViewDataSource, UITableViewDelegate {
    ...
    override func viewWillAppear(_: Bool) {
        let frame: CGRect = CGRect(x: 0, y: 100, width: view.frame.width, height: view.frame.height / 2.2)
    ...
    func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        ...
        for emailAddress in currentContact.emailAddresses {
            ...
            let takePictureAction: UIAlertAction = UIAlertAction(title: homeEmailAddress, style: .default) { _ -> Void in
        ...
        let removeAction: UIAlertAction = UIAlertAction(title: "Remove", style: .default) { _ -> Void in
