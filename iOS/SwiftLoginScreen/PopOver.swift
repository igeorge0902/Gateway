 ...
 */
var SeatsData_:Array< SeatsData > = Array < SeatsData >()
/**
 Stores returned Ticket objects in Array.
 */
var TicketsData_:Array< TicketsData > = Array < TicketsData >()
...
class PopOver: UIViewController, UIViewControllerTransitioningDelegate, UITableViewDelegate, UITableViewDataSource {
    ...
    override func viewDidLoad() {
        ...
        tableView_?.addSubview(self.refreshControl)

    }
    
    override func viewWillAppear(_ animated: Bool) {
        
        let frame2 = CGRect(x: self.view.frame.width * 0.10, y: 55, width: self.view.frame.width, height: 20)
        ...
        let frame:CGRect = CGRect(x: 0, y: 90, width: self.view.frame.width, height: self.view.frame.height-50)
...
extension PopOver: UICollectionViewDelegate, UICollectionViewDataSource {
            ...
            for i in 0 ..< filteredAttendees.count {
                ...
                if indexPath.item == i {
                    ...
                    seatData.forEach { item in
                        ...
                        _ = item.contains {  (key, value) -> Bool in
    ...
    func collectionView(_ collectionView: UICollectionView, didSelectItemAt indexPath: IndexPath) {
        ...
        let seatIds = [Int](seatsToBeReserved.keys.sorted(by: { return $0 < $1 }))
