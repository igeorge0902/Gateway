...
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`sqluser`@`localhost`*/ /*!50003 TRIGGER `deviceId_uuid` AFTER INSERT ON `devices` FOR EACH ROW BEGIN
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`root`@`localhost`*/ /*!50003 TRIGGER `vouchers` AFTER INSERT ON `logins` FOR EACH ROW BEGIN
       DECLARE uuid_ char(255);
