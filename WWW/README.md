...
@ TomCat
- the server.xml file provides default settings, you just need point your Apache to it. See also: [TomCat docs for AJP](https://tomcat.apache.org/tomcat-9.0-doc/config/ajp.html)

@ GlassFish
- [GlassFish behind Apache](http://www.codefactorycr.com/glassfish-behind-apache.html)
- [Oracle GlassFish Server 3.0.1 Administration Guide](https://docs.oracle.com/cd/E19798-01/821-1751/gixqw/index.html)

- make sure the JSESSIONID is passing through the Apache and is not cached at all. See mod_jk connector instructions: [Apache Connectors](http://tomcat.apache.org/connectors-doc/reference/apache.html)
...
- [AngularJS example for hmac](https://github.com/Monofraps/angular-node-hmac-example)
- [AngularJS Request Headers and Interceptors](http://www.devblogrbmz.com/angular-default-request-headers-and-interceptors/)
