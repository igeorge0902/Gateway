...
<body>
        ...
        <div id="nav-wrapper">
            ...
            <nav id="nav">
                <ul>
                    ...
                    <li class="active"><a href="https://milo.crabdance.com/example/index.jsp">Homepage</a></li>
    ...
    <div id="main">
        <div id="content" class="container">
            ...
            <div class="row">
                <section class="6u">
                    <a href="#" class="image full"><img src="../simple-service-webapp/webapi/myresource/images/s.jpg" alt=""></a>
                    <header>
                ...
                <section class="6u">
                    <a href="#" class="image full"><img src="../simple-service-webapp/webapi/myresource/images/e.jpg" alt=""></a>
                    <header>
                        <h2>Mauris vulputate dolor</h2>
                    </header>
                    <p>In posuere eleifend odio. Quisque semper augue mattis wisi. Maecenas ligula. Pellentesque viverra vulputate enim. Aliquam erat volutpat. Donec leo, vivamus fermentum nibh in augue praesent a lacus at urna congue rutrum.</p>
            ...
            <div class="row">
                <section class="6u">
                    ...
                    <a href="#" class="image full"><img src="../simple-service-webapp/webapi/myresource/images/m.jpg" alt=""></a>
                </section>
            </div>
            <div class="row">
                <section class="6u">
                    <a href="#" class="image full"><img src="../simple-service-webapp/webapi/myresource/images/mm.jpg" alt=""></a>
                    <header>
                        <h2>Mauris vulputate dolor</h2>
                    </header>
                    <p>In posuere eleifend odio. Quisque semper augue mattis wisi. Maecenas ligula. Pellentesque viverra vulputate enim. Aliquam erat volutpat. Donec leo, vivamus fermentum nibh in augue praesent a lacus at urna congue rutrum.</p>
                ...
                <section class="6u">
                    <a href="#" class="image full"><img src="../simple-service-webapp/webapi/myresource/images/d.jpg" alt=""></a>
                    <header>
                        <h2>Mauris vulputate dolor</h2>
                    </header>
                    <p>In posuere eleifend odio. Quisque semper augue mattis wisi. Maecenas ligula. Pellentesque viverra vulputate enim. Aliquam erat volutpat. Donec leo, vivamus fermentum nibh in augue praesent a lacus at urna congue rutrum.</p>
