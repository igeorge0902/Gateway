...
public class ServiceClient {
    ...
    public ServiceClient(String baseUrl, HttpServletRequest request, Map<String, String> attributes)
        ...
        client = (ResteasyClient) ResteasyClientBuilder.newBuilder().sslContext(sslContext).build();
    ...
    public Response deletePurchases() {
        purchasesService = target.proxy(Purchases.class);
        Response response = purchasesService.deletePurchases();
        return response;
    }
